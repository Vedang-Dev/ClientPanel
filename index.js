...
console.log(chalk.green("[ClientPanel] Files loading..."));

console.log(chalk.green("[ClientPanel] Files loaded..."));

// Load settings.

const settings = require("./settings.json");
console.log(chalk.green("[ClientPanel] Settings loading..."));
...
console.log(chalk.green("[ClientPanel] Settings loaded..."));
...
console.log(chalk.green("[ClientPanel] Database loading..."))

module.exports.db = db;

console.log(chalk.green("[ClientPanel] Database loaded..."))

// Load websites.

const express = require("express");
console.log(chalk.green("[ClientPanel] api's loading..."))
const app = express();
console.log(chalk.green("[ClientPanel] api's loaded..."))

// Load express addons.

const expressWs = require('express-ws')(app);
console.log(chalk.green("[ClientPanel] Express addons loading..."))
const ejs = require("ejs");
const session = require("express-session");
const indexjs = require("./index.js");
console.log(chalk.green("[ClientPanel] Express addons loaded..."))


// Sets up saving session data.

const sqlite = require("better-sqlite3");
console.log(chalk.green("[ClientPanel] Season data loading..."))
const SqliteStore = require("better-sqlite3-session-store")(session);
const session_db = new sqlite("sessions.db");
console.log(chalk.green("[ClientPanel] Season data loaded..."))

// Load the website.

module.exports.app = app;
console.log(chalk.green("[ClientPanel] Website loading..."))
